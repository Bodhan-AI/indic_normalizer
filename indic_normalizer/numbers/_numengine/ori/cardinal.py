from indic_normalizer.numbers._numengine.ori.data.nums import exceptions_dict
from indic_normalizer.numbers._numengine.ori.data.nums import direct_dict
from indic_normalizer.numbers._numengine.ori.data.nums import higher_dict

from indic_normalizer.numbers._numengine.ori.utils import combine
