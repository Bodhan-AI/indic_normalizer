from indic_normalizer.numbers._numengine.pun.data.nums import exceptions_dict
from indic_normalizer.numbers._numengine.pun.data.nums import direct_dict
from indic_normalizer.numbers._numengine.pun.data.nums import higher_dict

from indic_normalizer.numbers._numengine.pun.utils import combine
