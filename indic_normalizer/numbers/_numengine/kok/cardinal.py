from indic_normalizer.numbers._numengine.kok.data.nums import DIRECT_DICT
from indic_normalizer.numbers._numengine.kok.data.nums import NUMBER_SCALE_DICT
from indic_normalizer.numbers._numengine.kok.data.nums import VARIATIONS_DICT
from indic_normalizer.numbers._numengine.kok.utils import combine
...
def convert_to_text(number_str: str, number_len: int) -> list[str]:
    ...
    if len(number_str) == 3 and number_str.lstrip("0"):
        ...
        if number_str[0] == "6":
            ...
            hundreds.extend(
                combine(DIRECT_DICT[number_str[0]], NUMBER_SCALE_DICT["0"], "")
            )
