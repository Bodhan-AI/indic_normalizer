from indic_normalizer.numbers._numengine.kan.data.nums import direct_dict
from indic_normalizer.numbers._numengine.kan.data.nums import exceptions_dict
from indic_normalizer.numbers._numengine.kan.data.nums import higher_dict
from indic_normalizer.numbers._numengine.kan.data.nums import hundreds_dict
