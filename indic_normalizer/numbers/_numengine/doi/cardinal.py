from indic_normalizer.numbers._numengine.doi.data.nums import DIRECT_DICT
from indic_normalizer.numbers._numengine.doi.data.nums import NUMBER_SCALE_DICT
from indic_normalizer.numbers._numengine.doi.data.nums import VARIATIONS_DICT
from indic_normalizer.numbers._numengine.doi.utils import combine
